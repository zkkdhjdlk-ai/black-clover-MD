...
${user.bannedReason}` : '📄 *Motivo:* Sin Especificar'}\n\n🌟 Si quieres que seas desbaneado en este bot escribe a: Wa.me/525544876071`)     
return
}
}
...
let regaleatorio = ['registrar', 'reg', 'verificar', 'verify', 'register'].getRandom()
