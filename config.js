...
global.botnumber = '' //Ejemplo: +523138954963
global.confirmCode = ''
...
//• ↳𝑺𝑶𝑳𝑶 𝑴𝑶𝑫𝑬𝑹𝑨𝑫𝑶𝑹𝑬𝑺!
global.mods = ['525544876071', '5218711426787', '', '', '']

global.suittag = ['525544876071']
global.prems = []
...
global.nameqr = '𝙱𝙻𝙰𝙲𝙺〆ᴄʟᴏᴠᴇʀ 🍀'
global.sessions = 'blackSession'
global.jadi = 'blackJadiBot'

//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packsticker = `♾ ━━━━━━━━\n├ ɓσƭ:\n├ ρяοριєταяιο:\n├ ƒєϲнα ∂є ϲяєαϲιόи:\n├ нοяα:\n♾━━━━━━━━`
global.packname = `𝙱𝙻𝙰𝙲𝙺〆ᴄʟᴏᴠᴇʀ 🍀⭑`
global.author = `♾━━━━━━━━\n⇝͟͞BLACK メ CLOVER̵⋆\n⇝ ۵𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒-̱̅\n⇝ ${moment.tz('America/Los_Angeles').format('DD/MM/YY')}\n⇝ ${moment.tz('America/Los_Angeles').format('HH:mm:ss')} \n♾━━━━━━━━\n\n\n\nѕτιϲκєя ϐγ:𝕭𝖑𝖆𝖈𝖐 𝕮𝖑𝖔𝖛𝖊𝖗 ☘︎ `;
global.wm = '𓆪͟͞𝕭𝖑𝖆𝖈𝖐 𝕮𝖑𝖔𝖛𝖊𝖗 ☘︎ ';
global.titulowm = ' 𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒͟͞';
global.titulowm2 = `͟͞ ৎ𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒̤𓆪 ͟͞`
global.igfg = '𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒'
global.botname = '𝙱𝙻𝙰𝙲𝙺〆ᴄʟᴏᴠᴇʀ🍀'
global.dev = '✯𝑃𝑎𝑤𝑒𝑟 𝐵𝑦 𝑇𝐻𝐸 𝐿𝐸𝐺𝐸𝑁𝐷𝑆 ⚡ '
global.textbot = '𝑩𝑳𝑨𝑪𝑲 𝑪𝑳𝑶𝑽𝑬𝑹 : 𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒'
global.gt = '͟͞𝙱𝙻𝙰𝙲𝙺〆ᴄʟᴏᴠᴇʀ 🍀';
global.namechannel = '㋡ 𝐓𝐇𝐄 𝐋𝐄𝐆𝐄𝐍𝐃𝐒 ™'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝙱𝙻𝙰𝙲𝙺〆ᴄʟᴏᴠᴇʀ🍀', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'blackclover', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𖥔.𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨❞ ꔷ──᜔◇⃟̣̣⃕✨', jpegThumbnail: logo5 }}};
...
global.fgif2 = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`͟͞ 𓆩ꪶꪾ𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒࠱࠭ ͟͞`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `⏤͟͞𝙱𝙻𝙰𝙲𝙺〆ᴄʟᴏᴠᴇʀ\n  ͟͞ 𓆩ꪶꪾ𝐓𝐇𝐄 𝐂𝐀𝐑𝐋𝐎𝐒͟͞`, 'jpegThumbnail': logo4 }}}
