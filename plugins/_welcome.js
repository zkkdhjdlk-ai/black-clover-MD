export async function before(m, { conn, participants, groupMetadata }) {
    ...
    const welcomeImage = 'https://qu.ax/iWgBM.jpg'; // Imagen de bienvenida
    const goodbyeImage = 'https://qu.ax/ZhMao.jpg'; // Imagen de despedida
