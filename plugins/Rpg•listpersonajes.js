...
// Personajes TOP
const personajesTop = [
  { nombre: 'Cristo_rey 👑', precio: 1872737, habilidad: '✝️ Resurrección divina y control de todo el universo.' },
  { nombre: 'arcangel 😇', precio: 1600000, habilidad: '🛡 Protección celestial y fuego sagrado.' },
  { nombre: 'the_carlos 🧠', precio: 1450000, habilidad: '💻 Maestro del código y hacker de grimorios.' },
  { nombre: 'dragon_legendario 🐉', precio: precioAleatorio(100000, 1872737), habilidad: '🔥 Fuego ancestral que consume reinos enteros.' },
  { nombre: 'samurai_oscuro ⚔️', precio: precioAleatorio(100000, 1872737), habilidad: '🌑 Velo de sombras y técnica sin nombre.' },
  { nombre: 'dios_guerrero 🪖', precio: precioAleatorio(100000, 1872737), habilidad: '🩸 Fuerza brutal y sed de batalla infinita.' },
  { nombre: 'hechicero_supremo 🧙‍♂️', precio: precioAleatorio(100000, 1872737), habilidad: '🔮 Control total del espacio-tiempo.' },
  { nombre: 'rey_gigante 👹', precio: precioAleatorio(100000, 1872737), habilidad: '🏔 Pisada que destruye ciudades.' },
  { nombre: 'alma_fantasma 👻', precio: precioAleatorio(100000, 1872737), habilidad: '🌫 Intangibilidad y gritos del más allá.' },
  { nombre: 'reina_de_las_llamas 🔥', precio: precioAleatorio(100000, 1872737), habilidad: '👑 Control absoluto del fuego místico.' }
]
