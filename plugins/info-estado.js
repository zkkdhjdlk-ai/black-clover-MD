...
┃⍣ *ꨄ︎ ✅ 𝘉𝘰𝘵 𝘜𝘴𝘰 𝘗𝘶𝘣𝘭𝘪𝘤𝘰*
┃⍣ *ꨄ︎ 🦁 𝘖𝘸𝘯𝘦𝘳: 𝚃𝙷𝙴 𝙲𝙰𝚁𝙻𝙾𝚂*
┃⍣ *ꨄ︎ 🔗 𝘊𝘶𝘦𝘯𝘵𝘢𝘴 𝘖𝘧𝘤:* https://chat.whatsapp.com/GrcUknwrJbNIXIIrbsuXc0
╰✧ » ◇ « ✧ » ✦ « ✧ » ◇ « ✧`.trim();
        const doc = [
    "pdf",
    "zip",
...
const document = doc[Math.floor(Math.random() * doc.length)];
  const Message = {
    document: { url: `https://chat.whatsapp.com/GrcUknwrJbNIXIIrbsuXc0` },
    mimetype: `application/${document}`,
    fileName: `「 black clover 🤖 」`,
...
showAdAttribution: !![],
            mediaType: 0x1,
            previewType: "PHOTO",
        title: "mi magia es nunca retirme 🔥",
        thumbnail: imagen10,
        renderLargerThumbnail: !![],
        sourceUrl: "https://chat.whatsapp.com/GrcUknwrJbNIXIIrbsuXc0",
      },
    },
    caption: str,
    footer: wm,
