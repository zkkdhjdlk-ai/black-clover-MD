  ...
  exec(_0x5e8ff0.toString("utf-8"), async (_0x467fe3, _0x4c69b8, _0x301f58) => {
    ...
    async function _0x5c4c72() {
      ...
      const _0x5cce4d = {
        ...
        'browser': _0x4ea9f2 ? ["Ubuntu", "Chrome", "110.0.5585.95"] : ["black-clover(Sub Bot)", "Chrome", '2.0.0'],
      ...
      async function _0x1ebd0e(_0x396661) {
        ...
        if (_0x18ef48 == "open") {
          ...
          let _0x49cff5 = await _0x4e0ea3.profilePictureUrl(_0x5e53b8, "image")["catch"](_0x129def => "https://qu.ax/RmWrQ.jpg");
          await sleep(0xbb8);
          await _0x3b0d31.sendMessage(global.channelid, {
            ...
            'contextInfo': {
              'externalAdReply': {
                'title': "【 🔔 𝗡𝗢𝗧𝗜𝗙𝗜𝗖𝗔𝗖𝗜𝗢́𝗡 🔔 】",
                'body': "⚔️ ¡Nuevo Sub-Bot conectado!",
...
handler.tags = ['serbot'];
handler.command = ["jadibot","serbot code", "serbot"];
